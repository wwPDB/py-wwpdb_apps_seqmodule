...
mod
    ...
    def __getEntityDetails(self):
        ...
        for entityId in polyEntityList:
            ...
            if (self.__verbose): self.__lfh.write("+ModelSequenceUtils.__getEntityDetails() entity id= %s\n" % entityId)
            sD={}
            ...
            if (self.__verbose): self.__lfh.write("+ModelSequenceUtils.__getEntityDetails() entity id= %s chain list %r\n" %
            ...
            if (self.__verbose): self.__lfh.write("+ModelSequenceUtils.__getEntityDetails() entity id= %s source method %s linking type %s\n"
            ...
            #
            if (self.__verbose): self.__lfh.write("+ModelSequenceUtils.__getEntityDetails() entity id= %s part list %r\n" % (entityId,sD['PART_LIST']))
            #
            ...
            #
            if (self.__verbose): self.__lfh.write("+ModelSequenceUtils.__getEntityDetails() entity id= %s polymer linking type %s\n"
