##
# File:     doServiceRequestWsgi.wsgi     
# Created:  16-Dec-2009
#
# Updates:
...
wwPDB application framework.  This version depends only on WSGI.
...
class MyRequestApp(object):
    """  Handle server interaction using WSGI protocol.
    """
    def __init__(self,textString="Initialized from contructor",topPath="/www/wwpdb-dev",verbose=True,log=sys.stderr):
        """ 
        """
    ...
    def __call__(self, environment, responseApplication):
        ...
        try:
            ...
            self.__myParameterDict['request_path']=[myPath.lower()]
        ...
        ###
        seqT= SeqModWebApp(parameterDict=self.__myParameterDict,
...
##    
application = MyRequestApp("doServiceRequest - default initialization",topPath="/www/wwpdb-dev",verbose=True,log=sys.stderr)
