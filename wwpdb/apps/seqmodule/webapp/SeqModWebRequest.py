...
class SeqModResponseContent(ResponseContent):
    def __init__(self, reqObj=None, verbose=False,log=sys.stderr):
        ...
        self.__lfh=log
        #
        self._kyList=['title','citationtitle','pdbid','identifier','groupids','alignids','selectids','conflictreportpath','annotationreportpath',\
                      'aligntag','viewalign_order','editopid','edittimestamp','aligntimestamp','warningtext']
