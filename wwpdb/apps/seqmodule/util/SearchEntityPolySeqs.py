...
#
    __schemaMap = { "SELECT_ALL": "select r.structure_id, r.pdb_id, r.rcsb_annotator, r.status_code, r.date_begin_processing, e.entity_id, " + \
    ...
    def searchSameSequenceEntity(self, entryId="D_1000000000", seq=""):
        ...
        for row in rows:
            ...
            for item in ( "structure_id", "entity_id", "pdb_id", "rcsb_annotator", "status_code", "date_begin_processing" ):
                if (not item in row) or (not row[item]):
