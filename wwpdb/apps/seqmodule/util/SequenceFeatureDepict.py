...
class SequenceFeatureDepict(object):
    ...
    def markupReferenceFeatures(self):
        return self.__markupReferenceFeatures(sourceOrg=self.__fD['SOURCE_ORGANISM'],geneName=self.__fD['DB_GENE_NAME'],
                                              ec=self.__fD['DB_MOLECULE_EC'],synonyms=self.__fD['DB_MOLECULE_SYNONYMS'],
                                              moleculeName=self.__fD['DB_MOLECULE_NAME'],orgCommonName=self.__fD['SOURCE_COMMON_NAME'],
                                              strain=self.__fD['SOURCE_STRAIN'],isoformDescription=self.__fD['DB_ISOFORM_DESCRIPTION'])
