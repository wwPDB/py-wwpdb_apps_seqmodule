...
class ReferenceSequence(object):
    def __init__(self,verbose=False,log=sys.stderr):
        ...
        self.__attribStr= ['db_name', 'db_accession', 'db_code', 'db_isoform', 'db_isoform_description', 'name', 'keyword', 'sequence', 'comments', 'synonyms', 
                           'source_scientific', 'source_strain', 'taxonomy_id', 'gene', 'source_common', 'ec']
...
class ReferenceSequenceAssign(object):
    def __init__(self,verbose=True,log=sys.stderr):
        ...
        self.__attribInt=['ref_id','db_align_end','db_align_beg','seq_align_begin','seq_align_end',
                          'auth_seq_align_begin','auth_seq_align_end']
        self.clear()
...
class SequenceAssignArchive(object):
    ...
    def __init__(self,verbose=False,log=sys.stderr):
        ...
        self.__reset()
        #
        self.__attribMapB={'pdbx_strand_id' : 'seq_id',
