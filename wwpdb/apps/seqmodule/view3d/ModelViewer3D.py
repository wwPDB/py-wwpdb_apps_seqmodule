...
class ModelViewer3D(object):
    ...
    def launchJmol(self):
        ...
        htmlL.append('<applet name="jmolApplet0" id="jmolApplet0" code="JmolApplet" archive="JmolAppletSigned0.jar" codebase="/applets/jmol-dev/jsmol/java" mayscript="true" height="100%" width="100%">')
